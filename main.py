...
async def not_found_handler(request: Request, exc: HTTPException) -> HTMLResponse:
    return HTMLResponse('<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Pagina no encontrada | RENSOF</title><link rel="stylesheet" href="/assets/css/style.css"></head><body><main class="page-main"><section class="page-hero"><div class="container"><p class="eyebrow">404</p><h1>Pagina no encontrada</h1><p>La direccion solicitada no esta disponible o fue movida.</p><a class="btn btn-success" href="/">Volver al inicio</a></div></section></main></body></html>', status_code=404)
